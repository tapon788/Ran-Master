...
class read_input:
    def __init__(self, in_filename, in_sheet_index):
        ...
        self.filename = in_filename #"E:\\3gext\TGPC\input_TGPC.xlsx"
        self.RNC = []
        self.WBTS = []
        self.WCEL = []
        self.TRX = []
    ...
    def main(self):
            ...
            for parameter in self.PARAMVALUE:
                ...
                mo_class =  distname.split('/')[-1].split('-')[0]
                ...
                for aParameter in parameter:
                    ...
                    try:
                        ...
                        p.text = (str(e).split(":")[1].strip().replace('\'', ''))
                        pass
            ...
            fp = open(entry_local_working_dir.get()+"out_"+mo_class+".xml","w+")
